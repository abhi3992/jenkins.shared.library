...
import com.utilities.NodeJSService
...
def call(Map config){
    ...
    def packageManager = (config.containsKey('packageManager')) ? config.packageManager : 'yarn'
            ...
            try{
                if("${env.BRANCH_NAME}" ==~ GlobalVars.buildPackageRegex){
                    ...
                    stage('build'){
                        ...
                        NodeJSService.build(this, packageManager)
